# Migration vom alten Schaltwerk-System
...
Erstelle oder erweitere die `.env`-Datei im `schaltwerk-backend` Verzeichnis:

```env
# Neue Datenbank (bereits konfiguriert)
DATABASE_URL=postgresql://user:password@localhost:5432/schaltwerk_pro
# oder
DB_HOST=localhost
DB_PORT=5432
